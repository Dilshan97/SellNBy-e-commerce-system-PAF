	                ...
	                <div class="modal-dialog modal-side modal-top-left modal-notify modal-info" role="document">
	                  ...
	                  <div class="modal-content">
	                    ...
	                    <div class="modal-body">
	                      ...
	                      <img src="../../../wp-content/uploads/2016/11/admin-dashboard-bootstrap.jpg" alt="Material Design for Bootstrap - dashboard"
	                        class="img-fluid">
	                    ...
	                    <div class="modal-body">
	                      ...
	                      <div class="row">
	                        <div class="col-3 text-center">
	                          <img src="../../../img/Photos/Avatars/img%20(1).jpg" alt="Michal Szymanski - founder of Material Design for Bootstrap"
	              ...
	              <div class="modal fade" id="modalLoginAvatarDemo" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
	                ...
	                <div class="modal-dialog cascading-modal modal-avatar modal-sm" role="document">
	                  ...
	                  <div class="modal-content">
	                    ...
	                    <!--Header-->
	                    <div class="modal-header">
	                      <img src="../../../img/Photos/Avatars/img%20(1).jpg" class="rounded-circle img-responsive"
	                        alt="Avatar photo">
	                    </div>
	                    <!--Body-->
	            ...
	            <div class="card-body">
	              ...
	              <div class="row">
	                ...
	                <div class="col-md-3">
	                  ...
	                  <img src="../../../img/brandflow/modal4.jpg" alt="MDB graphics" class="img-fluid z-depth-1">
	                  <div class="text-center">
	                ...
	                <div class="col-md-3">
	                  ...
	                  <img src="../../../img/brandflow/modal3.jpg" alt="MDB graphics" class="img-fluid z-depth-1">
	                  <div class="text-center">
	                    <h5 class="my-3">Position</h5>
	                ...
	                <div class="col-md-3">
	                  ...
	                  <img src="../../../img/brandflow/modal2.jpg" alt="MDB graphics" class="img-fluid z-depth-1">
	                  <div class="text-center">
	                ...
	                <div class="col-md-3">
	                  ...
	                  <img src="../../../img/brandflow/modal1.jpg" alt="MDB graphics" class="img-fluid z-depth-1">
	                  <div class="text-center">
	                    <h5 class="my-3">Position</h5>
