                            ...
                            <div class="row mx-md-4 mx-1">
                                <div class="col-md-12 col-lg-4 sub-menu my-lg-5 mt-5 mb-4">
                                    ...
                                    <div class="view overlay mb-3 z-depth-1">
                                        <img src="assets/img/Photos/Horizontal/E-commerce/Products/9.jpg" class="img-fluid" alt="First sample image">
                        ...
                        <div class="dropdown-menu mega-menu v-2 row z-depth-1 white" aria-labelledby="navbarDropdownMenuLink1">
                            <div class="row mx-md-4 mx-1">
                                ...
                                <div class="col-md-6 col-xl-3 sub-menu my-xl-5 mt-md-5 mt-4 mb-4">
                                    ...
                                    <!--Featured image-->
                                    <div class="view overlay mb-3 z-depth-1">
                                        <img src="assets/img/Photos/Horizontal/Work/6-col/img%20(43).jpg" class="img-fluid" alt="First sample image">
                                        <div class="mask flex-center rgba-white-slight">
                                            <p></p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 col-xl-3 sub-menu my-xl-5 mt-4 mb-4">
                                    ...
                                    <!--Featured image-->
                                    <div class="view overlay mb-3 z-depth-1">
                                        <img src="assets/img/Photos/Horizontal/E-commerce/Products/6.jpg" class="img-fluid" alt="First sample image">
                                        <div class="mask flex-center rgba-white-slight">
                                            <p></p>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12 mb-3 pb-lg-2">
                            ...
                            <div class="view zoom z-depth-1">
                                ...
                                <img src="assets/img/Photos/Others/product1.jpg" class="img-fluid" alt="sample image">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 d-flex align-items-center">
                                                    ...
                                                    <div class="view overlay">
                                                        <img src="assets/img/Photos/Horizontal/E-commerce/Products/13.jpg" class="img-fluid" alt="">
                                                        <a>
                                                ...
                                                <div class="col-6 pl-0">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <h5 class="card-title mb-1"><strong><a href="#" class="dark-grey-text">iPhone 7</a></strong></h5>
                                        ...
                                        <div class="card card-ecommerce">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 d-flex align-items-center">
                                                    <!--Card image-->
                                                    <div class="view overlay">
                                                        <img src="assets/img/Photos/Horizontal/E-commerce/Products/1.jpg" class="img-fluid" alt="">
                                                        <a>
                                                            <div class="mask rgba-white-slight"></div>
                                                        </a>
                                                    </div>
                                        ...
                                        <div class="card card-ecommerce">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 d-flex align-items-center">
                                                    <!--Card image-->
                                                    <div class="view overlay">
                                                        <img src="assets/img/Photos/Horizontal/E-commerce/Products/14.jpg" class="img-fluid" alt="">
                                                        <a>
                                                            <div class="mask rgba-white-slight"></div>
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="col-6 pl-0">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <h5 class="card-title mb-1"><strong><a href="#" class="dark-grey-text">Sony TV RT56</a></strong></h5>
                                                        <span class="badge badge-danger mb-2">bestseller</span>
                                                        <!-- Rating -->
                                                        <ul class="rating">
                                                            <li><i class="fas fa-star blue-text"></i></li>
                                        ...
                                        <div class="card card-ecommerce">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 d-flex align-items-center">
                                                    <!--Card image-->
                                                    <div class="view overlay">
                                                        <img src="assets/img/Photos/Horizontal/E-commerce/Products/10.jpg" class="img-fluid" alt="">
                                                        <a>
                                                            <div class="mask rgba-white-slight"></div>
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="col-6 pl-0">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <h5 class="card-title mb-1"><strong><a href="#" class="dark-grey-text">Philips V56</a></strong></h5>
                                                        <span class="badge badge-danger mb-2">bestseller</span>
                                                        <!-- Rating -->
                                                        <ul class="rating">
                                                            <li><i class="fas fa-star blue-text"></i></li>
                                        ...
                                        <div class="card card-ecommerce">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 d-flex align-items-center">
                                                    <!--Card image-->
                                                    <div class="view overlay">
                                                        <img src="assets/img/Photos/Horizontal/E-commerce/Products/12.jpg" class="img-fluid" alt="">
                                                        <a>
                                                            <div class="mask rgba-white-slight"></div>
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="col-6 pl-0">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <h5 class="card-title mb-1"><strong><a href="#" class="dark-grey-text">Dell V756</a></strong></h5>
                                                        <span class="badge badge-info mb-2">NEW</span>
                                                        <!-- Rating -->
                                                        <ul class="rating">
                                                            <li><i class="fas fa-star blue-text"></i></li>
                                        ...
                                        <div class="card card-ecommerce">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6 d-flex align-items-center">
                                                    <!--Card image-->
                                                    <div class="view overlay">
                                                        <img src="assets/img/Photos/Horizontal/E-commerce/Products/9.jpg" class="img-fluid" alt="">
                                                        <a>
                                                            <div class="mask rgba-white-slight"></div>
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="col-6 pl-0">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <h5 class="card-title mb-1"><strong><a href="#" class="dark-grey-text">Canon D-67i</a></strong></h5>
                                                        <span class="badge badge-info mb-2">NEW</span>
                                                        <!-- Rating -->
                                                        <ul class="rating">
                                                            <li><i class="fas fa-star blue-text"></i></li>
                    ...
                    <section>
                        ...
                        <div class="row mt-4 pt-1">
                            ...
                            <div class="col-lg-8 col-md-12 mb-3 mb-md-4 pb-lg-2">
                                <!--Image -->
                                <div class="view zoom z-depth-1">
                                    <img src="assets/img/Photos/Others/product2.jpg" class="img-fluid" alt="sample image">
                                    <div class="mask rgba-white-light">
                            ...
                            <div class="col-lg-4 col-md-12 mb-4">
                               ...
                               <div class="view zoom z-depth-1 photo">
                                <img src="assets/img/Photos/Others/product3.jpg" class="img-fluid" alt="sample image">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 mb-4">
                                ...
                                <div class="card card-ecommerce">
                                    ...
                                    <!--Card image-->
                                    <div class="view overlay">
                                        <img src="assets/img/Photos/Horizontal/E-commerce/Products/11.jpg" class="img-fluid" alt="">
                                        <a>
                                            <div class="mask rgba-white-slight"></div>
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-6 mb-4">
                                ...
                                <div class="card card-ecommerce">
                                    ...
                                    <!--Card image-->
                                    <div class="view overlay">
                                        <img src="assets/img/Photos/Horizontal/E-commerce/Products/7.jpg" class="img-fluid" alt="">
                                        <a>
                                            <div class="mask rgba-white-slight"></div>
                                        </a>
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-12 mb-4">
                                ...
                                <div class="card card-ecommerce">
                                    ...
                                    <!--Card image-->
                                    <div class="view overlay">
                                        <img src="assets/img/Photos/Horizontal/E-commerce/Products/3.jpg" class="img-fluid" alt="">
                                        <a>
                                            <div class="mask rgba-white-slight"></div>
                                        </a>
                                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-12 col-12 pt-4">
                                ...
                                <div class="row mt-5 py-2 mb-4 hoverable align-items-center">
                                    ...
                                    <div class="col-6">
                                        <a><img src="assets/img/Photos/Horizontal/E-commerce/Products/1.jpg" class="img-fluid"></a>
                                    </div>
                                    <div class="col-6">
                                ...
                                <div class="row mt-2 py-2 mb-4 hoverable align-items-center">
                                    ...
                                    <div class="col-6">
                                        <a><img src="assets/img/Photos/Horizontal/E-commerce/Products/10.jpg" class="img-fluid"></a>
                                    </div>
                                    <div class="col-6">
                                ...
                                <div class="row mt-2 py-2 pb-1 hoverable align-items-center">
                                    ...
                                    <div class="col-6">
                                        <a><img src="assets/img/Photos/Horizontal/E-commerce/Products/3.jpg" class="img-fluid"></a>
                                    </div>
                                    <div class="col-6">
                            ...
                            <div class="col-lg-4 col-md-12 pt-4">
                                ...
                                <div class="row mt-5 py-2 mb-4 hoverable align-items-center">
                                    ...
                                    <div class="col-6">
                                        <a><img src="assets/img/Photos/Horizontal/E-commerce/Products/4.jpg" class="img-fluid"></a>
                                    </div>
                                    <div class="col-6">
                                ...
                                <div class="row mt-2 py-2 mb-4 hoverable align-items-center">
                                    ...
                                    <div class="col-6">
                                        <a><img src="assets/img/Photos/Horizontal/E-commerce/Products/5.jpg" class="img-fluid"></a>
                                    </div>
                                    <div class="col-6">
                                ...
                                <div class="row mt-2 py-2 pb-1 hoverable align-items-center">
                                    ...
                                    <div class="col-6">
                                        <a><img src="assets/img/Photos/Horizontal/E-commerce/Products/6.jpg" class="img-fluid"></a>
                                    </div>
                                    <div class="col-6">
                            ...
                            <div class="col-lg-4 col-md-12 pt-4">
                                ...
                                <div class="row mt-5 py-2 mb-4 hoverable align-items-center">
                                    ...
                                    <div class="col-6">
                                        <a><img src="assets/img/Photos/Horizontal/E-commerce/Products/7.jpg" class="img-fluid"></a>
                                    </div>
                                    <div class="col-6">
                                ...
                                <div class="row mt-2 py-2 mb-4 hoverable align-items-center">
                                    ...
                                    <div class="col-6">
                                        <a><img src="assets/img/Photos/Horizontal/E-commerce/Products/8.jpg" class="img-fluid"></a>
                                    </div>
                                    <div class="col-6">
                                ...
                                <div class="row mt-2 py-2 mb-4 hoverable align-items-center">
                                    ...
                                    <div class="col-6">
                                        <a><img src="assets/img/Photos/Horizontal/E-commerce/Products/9.jpg" class="img-fluid"></a>
                                    </div>
                                    <div class="col-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="view z-depth-1">
                                ...
                                <img src="assets/img/Photos/Others/ecommerce5.jpg" class="img-fluid" alt="sample image">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 mb-4">
                            ...
                            <div class="card card-ecommerce">
                                ...
                                <!--Card image-->
                                <div class="view overlay">
                                    <img src="assets/img/Photos/Horizontal/E-commerce/Products/16.jpg" class="img-fluid" alt="">
                                    <a>
                                        <div class="mask rgba-white-slight"></div>
                                    </a>
                                </div>
